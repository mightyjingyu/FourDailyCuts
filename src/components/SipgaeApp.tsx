...
const HIGHKEY_FILTER = "brightness(1.18) contrast(1.10) saturate(1.08)";
const SHADOW_LIFT_ALPHA = 0.04;
const WHITE_OVERLAY_COLOR = "#f0f8ff";
const WHITE_OVERLAY_ALPHA = 0.03;
const JAW_SLIM_STRENGTH = 0.46;
const EYE_VERTICAL_STRETCH = 1.018;
const MIDFACE_COMPRESS = 0.94;
const SKIN_SMOOTH_BLUR_PX = 2.0;
const SKIN_SMOOTH_ALPHA = 0.28;
const SKIN_SMOOTH_GLOBAL_ALPHA = 0.0;
const EDGE_SHARPEN_CONTRAST = 1.30;
const CATCHLIGHT_ALPHA = 0;
const NOSE_SLIM_STRENGTH = 0.22;
const FACE_SLIM_STRENGTH = 0.24;
