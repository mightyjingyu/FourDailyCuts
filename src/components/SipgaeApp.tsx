...
const EYE_VERTICAL_STRETCH = 1.065;
const EYE_HORIZONTAL_STRETCH = 1.22;
const MIDFACE_COMPRESS = 0.91;
const SKIN_SMOOTH_BLUR_PX = 9.0;
const SKIN_SMOOTH_ALPHA = 0.88;
const SKIN_SMOOTH_GLOBAL_ALPHA = 0.32; // 전체 프레임 베이스 블러 (경계 완화용)
const EDGE_SHARPEN_CONTRAST = 1.30;
const CATCHLIGHT_ALPHA = 0;
const NOSE_SLIM_STRENGTH = 0.14;
const FACE_SLIM_STRENGTH = 0.52;
