...
const JAW_SLIM_STRENGTH = 0.90;
const EYE_VERTICAL_STRETCH = 1.10;
const EYE_HORIZONTAL_STRETCH = 1.32;
const MIDFACE_COMPRESS = 0.91;
const SKIN_SMOOTH_BLUR_PX = 11.0;
const SKIN_SMOOTH_ALPHA = 0.92;
const SKIN_SMOOTH_GLOBAL_ALPHA = 0.35; // 전체 프레임 베이스 블러 (경계 완화용)
const EDGE_SHARPEN_CONTRAST = 1.30;
const CATCHLIGHT_ALPHA = 0;
const NOSE_SLIM_STRENGTH = 0.14;
const FACE_SLIM_STRENGTH = 0.68;
        ...
        {step === "home" && (
          ...
          >
            ...
            <p style={{ fontSize: "0.95rem", color: "#666666", lineHeight: 1.6 }}>
              (모바일은 보정이 제한될 수 있어 PC 사용을 권장합니다)
            </p>
            <button
              type="button"
